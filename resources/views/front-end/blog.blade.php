    ...
    <div id="slider-1" class="mbr-slider carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
                <img src="{{URL::to('homescreen/pictures/carousel-img1.png')}}" alt="inventory-your-tree.png" class="nopadding col-lg-6 col-md-12 col-xs-12">
            ...
            <div class="carousel-item">
                ...
                <img src="{{URL::to('homescreen/pictures/carousel-img2.png')}}" alt="inventory-your-tree.png" class="nopadding col-lg-6 col-md-12 col-xs-12">
            ...
            <div class="carousel-item">
                <img src="{{URL::to('homescreen/pictures/carousel-img3.png')}}" alt="inventory-your-tree.png" class="nopadding col-lg-6 col-md-12 col-xs-12">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div id="slider-2" class="mbr-slider carousel slide" data-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <img src="{{URL::to('homescreen/pictures/carousel2-img1.png')}}" alt="our-mission.png" class="center-block" style="height: 45vh; padding:3vh">
                        ...
                        <div class="carousel-item">
                            <img src="{{URL::to('homescreen/pictures/carousel2-img2.png')}}" alt="manage-data-collection.png" class="center-block" style="height: 45vh; padding:3vh">
                        ...
                        <div class="carousel-item">
                            <img src="{{URL::to('homescreen/pictures/carousel2-img3.png')}}" alt="model-future-planning.png" class="center-block" style="height: 45vh; padding:3vh">
