            ...
            <div class="x_content" style="display: none">
                <div class="row">
                    <div class="col-md-12 col-xs-12 col-sm-12">
                        ...
                        <input id="treatment_name" class="col-md-2" type="text" placeholder="Perlakuan"/>
                    ...
                    <table class="table table-striped table-bordered">
                        <thead>
                            <tr class="row">
                                ...
                                <th class="col-md-5 col-sm-5 col-xs-5">Tipe Spesies</th>
                                <th class="col-md-1 col-sm-1 col-xs-1">Operasi</th>
                            </tr>
                        </thead>
                        <tbody>
                           <?php $i=0 ?>
                            @foreach($datas as $treatment)
                            <?php $i++ ?>
                            <tr class="row">
                                <td class="col-md-1 col-sm-1 col-xs-1">{{$i}}</td>
                                <td class="col-md-5 col-sm-5 col-xs-5">{{$treatment->name}}</td>
                                <td class="col-md-5 col-sm-5 col-xs-5" data-id='{{$treatment->species_type_id}}'>{{$treatment->speciesType->species_type_name}}</td>
                                <td class="col-md-1 col-sm-1 col-xs-1">
                                   <div data-id="{{$treatment->id}}" role="group" class="btnGroupOperation btn-group btn-group-justified">
