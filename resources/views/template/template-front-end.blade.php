...
<html>
    <head>
        ...
        <link rel="stylesheet" href="{{URL::to('general/bootstrap/css/bootstrap.min.css')}}"/>
    ...
    <body>
        ...
        <script type='text/javascript' src="{{URL::to('general/bootstrap/js/bootstrap.min.js')}}"></script>
